<div class="preloader_wrapper">
    <div class="preloader_inner">
        <img src="assets/images/loader-sita.gif" alt="image" width="150" />
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2">
                <div class="clv_left_header">
                    <div class="clv_logo">
                        <a href="home"><img src="assets/images/logo2.png" alt="SITA SA" /></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-10 col-md-10">
                ...
                <div class="clv_right_header">
                    ...
                    <div class="clv_menu">
                        ...
                        <div class="cart_nav">
                            <ul>
                                ...
                                <li class="menu_toggle">
                                    <span style="font-weight: 900; margin-left: 2%;">
                                        <?xml?>
                        ...
                        <a href="contact" class="appointment_btn">Contactez-nous</a>
                    </div>
                    
                    <!-- end menu -->

                    <!-- <a href="contact.html" class="appointment_btn">contactez-nous</a> -->
                </div>
                <!-- end header -->
            </div>
        </div>
